...
public class ApprovalImportTemplateWriter {
    ...
    /**
     * 예시 줄. 문서번호가 '예시'로 시작하면 파서가 건너뛰므로,
     * 기관이 지우지 않고 아래에 이어서 채워도 예시가 진짜 문서로 등록되지 않는다.
     */
    private static final String[][] SAMPLES = {
            {"예시-001", "1월 정기 사례회의록", "홍길동", "2025-01-03", "완료", "회의록",
                    "김검토", "2025-01-04", "박원장", "2025-01-05", "", "",
                    "2025-001_회의록.pdf"},
            {"예시-002", "1월 소모품 구입 지출품의", "이영희", "2025-01-08", "완료", "지출",
                    "박원장", "2025-01-09", "", "", "", "",
                    "2025-002_지출품의.pdf, 견적서.pdf"},
            {"예시-003", "2월 야유회 계획(반려)", "홍길동", "2025-02-11", "반려", "일반",
                    "박원장", "2025-02-12", "", "", "", "",
                    ""},
    };
    ...
    private static final String[][] GUIDE = {
            ...
            {"", "", "회색 예시 줄은 지워도 되고 그대로 둬도 됩니다 — 문서번호가 '예시'로 시작하는 줄은 등록되지 않습니다."},
